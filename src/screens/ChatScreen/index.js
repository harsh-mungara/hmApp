...
const ChatScreen = ({user, route}) => {
  ...
  const Data = useRoute();
  // const [phoneNo, setPhoneNo] = useState(Data.params.phoneNo)
  const [messages, setMessages] = useState([]);
  const [uid, setUid] = useState(get(Data, 'params.uid'));
  const [username, setUsername] = useState(get(Data, 'params.name'));
